 ...
 * @author thasiii
 */
public class dashboard4user extends javax.swing.JFrame {

   public static java.sql.Timestamp logout; 
   
    public dashboard4user() {
        initComponents();
        setDefaultCloseOperation(dashboard4user.EXIT_ON_CLOSE);
...
class jPanelGradient extends JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("         PIE CHART AND BAR CHART");
